...
const SignupPage = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      // If email confirmation were ON, you would show this message:
  ...
  const handleSignup = (e) => {
    ...
    if (!result.success) {
      // Set the error message from Zod
      ...
      <div className="p-8 bg-white rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleSignup}>
            ...
            <div className="mb-4">
                ...
                <input id="username" name="username" className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500" type="text" placeholder="e.g., john_doe" required />
            </div>
            <div className="mb-4">
            ...
            <div className="mb-6">
                ...
                <select name="role" className="w-full p-3 border border-gray-300 rounded-md bg-white focus:ring-2 focus:ring-blue-500" defaultValue="user">
